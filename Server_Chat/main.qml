...
Window {
    ...
    Text {
        ...
        font.bold: true
        color: "#000"
        text: CTRL.isConnected ? "Connected!" : "Connect"
    }
    ...
    Rectangle {
        ...
        color: CTRL.isConnected ? "#40ce00" : "#999999"
    }
    ...
    MouseArea {
        ...
        onClicked:
            if(!port.focus)
                CTRL.isConnected ? CTRL.disconnect() : CTRL.doConnect(port.text)
    }
